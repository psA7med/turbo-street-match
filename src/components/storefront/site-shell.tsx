    ...
    <header className="sticky top-0 z-40 border-b border-border bg-background/95 backdrop-blur">
      <div className="turbo-container flex h-18 items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-1">
          ...
          <Link className="relative p-3" to="/cart" aria-label="السلة"><ShoppingBag className="size-5" /><span className="absolute end-1 top-1 grid size-4 place-items-center rounded-full bg-primary text-[10px] font-bold text-primary-foreground">0</span></Link>
        </div>
      </div>
    </header>
  </>;
